  ...
  init: function () {
    ...
    this.stylesTab = {
      ...
      contents: async function () {
        ...
        this.log('stylesTab', this.params)

        html += await this.viewRender(styleEditorTemplate, {trackid: 'stylesTabs', elementsDefs, feObj: this.params.feObj, editor: this.params.editor})
        return html
      }
    }
    this.actionsTab = {
