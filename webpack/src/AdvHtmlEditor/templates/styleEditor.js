...
export default {
  ...
  render: async function (params) {
    ...
    var elementContents = async function (styleElementName, elementDef) {
      ...
      html += await this.viewRender('ui/tabs', { trackid: 'elementStatesStyles_' + styleElementName, classes: ['elementStatesStyles'], tabClasses: ['elementStateStyles'], tabs, feObj: this.params.feObj, editor: this.params.editor}, {styles: [mainView, 'styles']})
      return html
    }
    ...
    var styles = this.param('feObj').styles
    this.param('styles', styles)
    ...
    html += await this.viewRender('ui/tabs', {trackid: 'elementStyle', classes: [], tabClasses: ['elementStyle'], tabs, feObj: this.params.feObj, editor: this.params.editor}, {styles: [mainView, 'styles']})
    html += '</div>'
    return html
  },
  init: function () {
    ...
    this.setProp = (element, state, prop, value) => {
      ...
      this.param('styles', Object.assign({}, this.params.styles))
      console.log('stylesJSON', JSON.stringify(this.params.styles), JSON.stringify(this.params.feObj.styles), this.usedParams, {element, state, prop, value})
      // this.domUpdate()
