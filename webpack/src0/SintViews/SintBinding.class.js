...
export default class SintBinding {
  ...
  addBinding (connectedObj, connectedObjProp, getAction, setAction, view) {
    ...
    Object.defineProperty(this.obj, this.prop, {
      ...
      set: (value) => {
        this.log('defineProperty Obj  SET', value, this.prop, this.obj)
    ...
    Object.defineProperty(connectedObj, connectedObjProp, {
      ...
      set: (value) => {
        this.log('connectedObjPropertyDescriptor Obj  SET', value, this.prop, this.obj)
