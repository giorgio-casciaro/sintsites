      ...
      return `<div class="advEditor">
        ...
        <div class="advEditorOverlayerAndBody">
          <div class="advEditorOverlayer">${
            ...
            <div class="advEditorOverlayerUi" style="width:${this.editor.selectedFeObject.body.dom.clientWidth}px;left:${relativeBoundingClientRect.left}px; bottom:${relativeBoundingClientRect.top}px">${this.viewRenderByView(this.editor.selectedFeObject.ui)}</div>
