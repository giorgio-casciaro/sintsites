...
var startTest = async function (netClient) {
  ...
  var frontEndCache = { id: 'frontEndCacheTest', views: { }, partial_view: [], mutation: [], queries: { } }
  var sessionId
  var listenerId
  ...
  var sessionResults = { viewsEventsCount: 0, views: { }, mutations: [], queries: { }, queriesEventsCount: 0, errors: [] }
  var getEvents = function () {
    var eventSourceInitOptions = { headers: { 'Cookie': 'app-meta-token=' + context.tokens['11111111-1111-1111-1111-111111111111'] } }
    var es = new EventSource('http://127.0.0.1/liveSession?maxViews=50&maxQueries=3&keepAlive=5', eventSourceInitOptions)
  ...
  liveSessionCommandResponse = await apiCallInternal('liveSessionCommands', { commands: [{ command: 'addRequest', params: { query: 'read', queryParams: { 'id': '11111111-1111-1111-1111-111111111111', fields: ['publicName'] } } }] }, { is_test: true, token: context.tokens.userAdminTest, sessionid: sessionId, listenerid: listenerId })
  mainTest.log('liveSessionCommandResponse', liveSessionCommandResponse)
  await new Promise((resolve) => setTimeout(resolve, 1000))
  await apiCallInternal('liveSessionCommands', { commands: [{ command: 'addRequest', params: { query: 'read', queryParams: { 'id': '11111111-1111-1111-1111-111111111111', fields: ['publicName'] } } }] }, { is_test: true, token: context.tokens.userAdminTest, sessionid: sessionId, listenerid: listenerId })
  await new Promise((resolve) => setTimeout(resolve, 1000))
  await apiCallInternal('liveSessionCommands', { commands: [{ command: 'addRequest', params: { query: 'read', queryParams: { 'id': '11111111-1111-1111-1111-111111111111', fields: ['publicName'] } } }] }, { is_test: true, token: context.tokens.userAdminTest, sessionid: sessionId, listenerid: listenerId })
  ...
  // mainTest.consoleResume()
  await new Promise((resolve) => setTimeout(resolve, 1000))
  var lastUpdatedResponse = await apiCallInternal('liveSessionCommands', { commands: [{ command: 'addRequest', params: { query: 'lastUpdated', queryParams: { fields: ['publicName'] } } }] }, { is_test: true, token: context.tokens.userAdminTest, sessionid: sessionId, listenerid: listenerId })
  ...
  // await apiCallInternal('liveSessionCommands', { commands: [{ command: 'emitEvent', params: { eventName: 'mutation', event } }] }, { is_test: true, token: context.tokens.userAdminTest, sessionid: sessionId, listenerid: listenerId })
  var updatePersonalInfo = await netClient.rpc('users', 'updatePersonalInfo', { id: '11111111-1111-1111-1111-111111111111', publicName: 'NewPublicName', firstName: 'firstName' }, { is_test: true, token: context.tokens.userAdminTest, sessionid: sessionId, listenerid: listenerId })
  ...
  mainTest.consoleResume()
  var removeRequestResponse = await apiCallInternal('liveSessionCommands', { commands: [{ command: 'removeRequest', params: { requestId: lastUpdatedResponse[0].data.requestId } }] }, { is_test: true, token: context.tokens.userAdminTest, sessionid: sessionId, listenerid: listenerId })
  log('removeRequestResponse', removeRequestResponse)

  var lastUpdatedPage2Response = await apiCallInternal('liveSessionCommands', { commands: [{ command: 'addRequest', params: { query: 'lastUpdated', queryParams: { fields: ['publicName'], from: 20, to: 30 } } }] }, { is_test: true, token: context.tokens.userAdminTest, sessionid: sessionId, listenerid: listenerId })
  log('lastUpdatedPage2Response', lastUpdatedPage2Response)
  await new Promise((resolve) => setTimeout(resolve, 2000))
  await apiCallInternal('liveSessionCommands', { commands: [{ command: 'removeRequest', params: { requestId: lastUpdatedPage2Response[0].data.requestId } }] }, { is_test: true, token: context.tokens.userAdminTest, sessionid: sessionId, listenerid: listenerId })

  var lastUpdatedPage3Response = await apiCallInternal('liveSessionCommands', { commands: [{ command: 'addRequest', params: { query: 'lastUpdated', queryParams: { fields: ['publicName'], from: 30, to: 40 } } }] }, { is_test: true, token: context.tokens.userAdminTest, sessionid: sessionId, listenerid: listenerId })
  log('lastUpdatedPage3Response', lastUpdatedPage3Response)
  await new Promise((resolve) => setTimeout(resolve, 2000))
  await apiCallInternal('liveSessionCommands', { commands: [{ command: 'removeRequest', params: { requestId: lastUpdatedPage3Response[0].data.requestId } }] }, { is_test: true, token: context.tokens.userAdminTest, sessionid: sessionId, listenerid: listenerId })
  ...
  await apiCallInternal('liveSessionCommands', { commands: [{ command: 'garbageCollection', params: { maxViews: 20 } }] }, { is_test: true, token: context.tokens.userAdminTest, sessionid: sessionId, listenerid: listenerId })
  await apiCallInternal('liveSessionCommands', { commands: [{ command: 'garbageCollection', params: { maxViews: 20 } }] }, { is_test: true, token: context.tokens.userAdminTest, sessionid: sessionId, listenerid: listenerId })
  await apiCallInternal('liveSessionCommands', { commands: [{ command: 'garbageCollection', params: { maxViews: 20 } }] }, { is_test: true, token: context.tokens.userAdminTest, sessionid: sessionId, listenerid: listenerId })
  await new Promise((resolve) => setTimeout(resolve, 2000))
  ...
  // var liveSessionCommandsResults = await apiCallInternal('liveSessionCommands', {  commands: [{ command: 'addRequest', params: { query: 'read', queryParams: { 'id': '11111111-1111-1111-1111-111111111111', fields: ['publicName'] } } }] }, { is_test: true, token: context.tokens.userAdminTest, sessionid: sessionId, listenerid: listenerId })
  ...
  // await new Promise((resolve) => setTimeout(resolve, 1000))
  //
  // var liveSessionCommandsResults = await apiCallInternal('liveSessionCommands', {  commands: [{ command: 'addRequest', params: { query: 'list', queryParams: {  fields: ['publicName'] } } }] }, { is_test: true, token: context.tokens.userAdminTest, sessionid: sessionId, listenerid: listenerId })
  // console.log('liveSessionCommandsResults', liveSessionCommandsResults)
  //
  // await new Promise((resolve) => setTimeout(resolve, 1000))
  //
